/*Nom: Arnau Martin S'ha d'optimitzar aquest codi tot el que pugueu.
...
int suma_carta(int i, int puntos, struct carta mano[])
{
...
bool calcular_puntos(int puntos)
{
  if (puntos > 21)
  {
...
int main()
{
  ...
  do
  {
    ...
    if (principi)
    {
      ...
      {
        puntos = suma_carta(i, puntos, mano);
      }
      if (calcular_puntos(puntos) == false)
      {
        repetir = false;
        break;
      }
    ...
    case 1:
      ...
      puntos = suma_carta(num_cartas_mano, puntos, mano);
      num_cartas_mano++;
      if (calcular_puntos(puntos) == false)
      {
        repetir = false;
    ...
    case 3:
      ...
      while (puntosMaquina < puntos)
      {
        ...
        puntosMaquina = suma_carta(i, puntosMaquina, manoMaquina);
